/**
 * Step07GoodsReceipt.controller.js — E2E Step 7: Goods Receipt (finished goods)
 */
sap.ui.define([
    ...
    return Controller.extend("com.capstone.dashboard.fioridashboard.controller.features.e2e.Step07GoodsReceipt", {
        ...
        onNodePress: function () {
            ...
            MessageToast.show("Step 7 — Goods Receipt selected");
        },

        /** TODO: OData finished goods receipt read */
