/**
 * Step05GoodsReceipt.controller.js — E2E Step 5: Goods Receipt
 */
sap.ui.define([
    ...
    return Controller.extend("com.capstone.dashboard.fioridashboard.controller.features.e2e.Step05GoodsReceipt", {
        ...
        onNodePress: function () {
            ...
            MessageToast.show("Step 5 — Goods Receipt selected");
        },

        /** TODO: OData Goods Receipt / Material Document read */
