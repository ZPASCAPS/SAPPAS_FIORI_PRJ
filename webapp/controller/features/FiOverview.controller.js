/**
 * FiOverview.controller.js — FI Overview Cockpit
...
sap.ui.define([
    ...
    return Controller.extend("com.capstone.dashboard.fioridashboard.controller.features.FiOverview", {
        ...
        _waitForDashboardModel: function () {
            ...
            if (!oModel.getProperty("/fiOverview") || !oModel.getProperty("/fiOverview/summaryCards") || !oModel.getProperty("/fiOverview/summaryCards").length) {
